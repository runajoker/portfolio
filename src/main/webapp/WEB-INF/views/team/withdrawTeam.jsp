...
<div class="jumbotron">
  <div class="row" align="center">
    <span align="center"><h3><strong>${vo.t_name}팀 탈퇴</strong></h3></span>
...
<tr>
	<td colspan="2"><input type="submit" class="btn btn-primary" value="탈퇴" /><input type="reset" class="btn btn-danger" value="취소" onclick="location.href='../team/'"/></td>
</tr>
</table>
</form>
  </div><!-- row -->
