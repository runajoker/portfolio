...
function awayMatching(mat_no){
   if(confirm('정말 매칭을 하시겠습니까?')==true){
      location.href = mat_no+'/awayMatching';
   }else{
      return;      
   }   
}
...
<div class="jumbotron">
   <div class="row">
      ...
      <div class="container">
              <hr/>
              <div class="row">
              <span align="center"><h3><strong>매칭 리스트</strong></h3></span>
                           ...
                           <tr>
                               <td>
                                   <span style='float:right'>
                                       <button type="button" id="list" class="btn btn-default"   onClick="self.location='../';">메인</button>
                                   </span>
                               </td>
                           </tr>
                       </thead>
